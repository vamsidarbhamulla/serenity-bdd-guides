...
.Step 3:
Add the downloaded folder path (C:\webdrivers) to environment variable named "PATH" using the steps provided in the screenshots below. +
...
[source,bash]
-----------------
where chromedriver //you should see C:\Webdrivers\chromedriver
-----------------

.Step 5: Optional:
Incase of environment variables not accesible run windows operating system in admin mode
